...
const Company = ({
  ...
  return (
    <View style={[styles.section, { maxWidth: '50%', paddingRight: 10 }]}>
      ...
      <Text style={{ fontSize: 12, color: '#F07F3C' }}>{company.name}</Text>
...
const Line = ({
  ...
  <View style={styles.lineRow}>
    ...
    <Text style={[styles.line, styles.tableFormat[1]]}>{line.description}</Text>
...
const Payment = ({
  ...
  <View style={{ lineHeight: 1.5, color: '#476976' }}>
    {payment.method && (
      <View>
        ...
        >
          ...
          >
            <Text>
              ...
              <Link style={{ color: '#F07F3C' }} src="https://www.credimi.com/">
                Credimi.com
              </Link>
            </Text>
          </View>
